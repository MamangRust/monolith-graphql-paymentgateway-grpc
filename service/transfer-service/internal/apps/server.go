...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/handler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/middleware"
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/service"
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterTransferStatsAmountServiceServer(grpcServer, handler)
	pbStats.RegisterTransferStatsStatusServiceServer(grpcServer, handler)
}
