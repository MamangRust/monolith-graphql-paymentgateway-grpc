...
import (
	...
	transfer_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/transfer_errors/service"
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/transfer"
	"github.com/MamangRust/monolith-graphql-payment-gateway-shared/observability"
	"github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/errorhandler"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-transfer/internal/repository"
...
//   - *response.ErrorResponse: Error details if operation fails.
func (s *transferCommandService) RestoreTransfer(ctx context.Context, transfer_id int) (*response.TransferResponseDeleteAt, *response.ErrorResponse) {
