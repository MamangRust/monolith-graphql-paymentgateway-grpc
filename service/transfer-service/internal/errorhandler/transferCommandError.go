...
import (
	...
	sharederrorhandler "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errorhandler"
...
// Returns:
//   - A TransferResponse with error details and a standardized ErrorResponse.
func (t *transferCommandError) HandleRestoreTransferError(err error, method, tracePrefix string, span trace.Span, status *string, fields ...zap.Field) (*response.TransferResponseDeleteAt, *response.ErrorResponse) {
	return handleErrorRepository[*response.TransferResponseDeleteAt](t.logger, err, method, tracePrefix, span, status, transfer_errors.ErrFailedRestoreTransfer, fields...)
}
