...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/errorhandler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/handler"
	myhandlerkafka "github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/kafka"
	"github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/middleware"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/repository"
	"github.com/MamangRust/monolith-graphql-payment-gateway-saldo/internal/service"
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterSaldoStatsBalanceServiceServer(grpcServer, handler)
	pbStats.RegisterSaldoStatsTotalBalanceServer(grpcServer, handler)
}
