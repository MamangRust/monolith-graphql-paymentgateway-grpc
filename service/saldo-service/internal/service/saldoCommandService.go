...
import (
	...
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/saldo"
...
func (s *saldoCommandService) RestoreSaldo(ctx context.Context, saldo_id int) (*response.SaldoResponseDeleteAt, *response.ErrorResponse) {
