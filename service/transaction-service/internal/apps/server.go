...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-transaction/internal/handler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-transaction/internal/middleware"
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterTransactionStatsAmountServiceServer(grpcServer, handler)
	pbStats.RegisterTransactionStatsMethodServiceServer(grpcServer, handler)
	pbStats.RegisterTransactionStatsStatusServiceServer(grpcServer, handler)
}
