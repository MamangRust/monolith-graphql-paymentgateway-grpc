...
import (
	...
	pbTransaction "github.com/MamangRust/monolith-graphql-payment-gateway-pb/transaction"
	...
	transaction_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/transaction_errors/grpc"
	protomapper "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/proto/transaction"
	"github.com/MamangRust/monolith-graphql-payment-gateway-transaction/internal/service"

	servicestats "github.com/MamangRust/monolith-graphql-payment-gateway-transaction/internal/service/stats"
	servicestatsbycard "github.com/MamangRust/monolith-graphql-payment-gateway-transaction/internal/service/statsbycard"
...
//   - An error if any.
func (t *transactionStatsStatusHandleGrpc) FindMonthlyTransactionStatusSuccess(ctx context.Context, req *pbTransaction.FindMonthlyTransactionStatus) (*pb.ApiResponseTransactionMonthStatusSuccess, error) {
...
//   - A pointer to the API response containing the transaction status success records.
//   - An error if any.
func (t *transactionStatsStatusHandleGrpc) FindYearlyTransactionStatusSuccess(ctx context.Context, req *pbTransaction.FindYearTransactionStatus) (*pb.ApiResponseTransactionYearStatusSuccess, error) {
	year := int(req.GetYear())
...
//   - An error if any.
func (t *transactionStatsStatusHandleGrpc) FindMonthlyTransactionStatusFailed(ctx context.Context, req *pbTransaction.FindMonthlyTransactionStatus) (*pb.ApiResponseTransactionMonthStatusFailed, error) {
	year := int(req.GetYear())
	month := int(req.GetMonth())
...
//   - A pointer to the API response containing the transaction status failed records.
//   - An error if any.
func (t *transactionStatsStatusHandleGrpc) FindYearlyTransactionStatusFailed(ctx context.Context, req *pbTransaction.FindYearTransactionStatus) (*pb.ApiResponseTransactionYearStatusFailed, error) {
	year := int(req.GetYear())
...
func (t *transactionStatsStatusHandleGrpc) FindMonthlyTransactionStatusSuccessByCardNumber(ctx context.Context, req *pbTransaction.FindMonthlyTransactionStatusCardNumber) (*pb.ApiResponseTransactionMonthStatusSuccess, error) {
	year := int(req.GetYear())
	month := int(req.GetMonth())
...
//   - An error if any validation or retrieval operation fails.
func (t *transactionStatsStatusHandleGrpc) FindMonthlyTransactionStatusFailedByCardNumber(ctx context.Context, req *pbTransaction.FindMonthlyTransactionStatusCardNumber) (*pb.ApiResponseTransactionMonthStatusFailed, error) {
	year := int(req.GetYear())
	month := int(req.GetMonth())
	cardNumber := req.GetCardNumber()
