...
import (
	...
	withdraw_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/withdraw_errors/service"
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/withdraw"
	"github.com/MamangRust/monolith-graphql-payment-gateway-shared/observability"
	"github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/errorhandler"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/repository"
...
//   - *response.ErrorResponse: Error information if any occurred.
func (s *withdrawCommandService) RestoreWithdraw(ctx context.Context, withdraw_id int) (*response.WithdrawResponseDeleteAt, *response.ErrorResponse) {
