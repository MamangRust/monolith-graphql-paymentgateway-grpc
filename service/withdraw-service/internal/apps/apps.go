...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/handler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/middleware"
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/service"
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterWithdrawStatsAmountServiceServer(grpcServer, handler)
	pbStats.RegisterWithdrawStatsStatusServiceServer(grpcServer, handler)
}
