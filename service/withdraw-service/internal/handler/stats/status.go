...
import (
	...
	pbWithdraw "github.com/MamangRust/monolith-graphql-payment-gateway-pb/withdraw"
	...
	withdraw_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/withdraw_errors/grpc"
	protomapper "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/proto/withdraw"

	service "github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/service"

	servicestats "github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/service/stats"
	servicestatsbycard "github.com/MamangRust/monolith-graphql-payment-gateway-withdraw/internal/service/statsbycard"
...
func (s *withdrawStatusHandleGrpc) FindYearlyWithdrawStatusSuccessByCardNumber(ctx context.Context, req *pbWithdraw.FindYearWithdrawStatusCardNumber) (*pb.ApiResponseWithdrawYearStatusSuccess, error) {
	year := int(req.GetYear())
	cardNumber := req.GetCardNumber()
...
//   - A pointer to an ApiResponseWithdrawYearStatusFailed message containing the yearly withdraw status for failed transactions.
//   - An error, which is non-nil if the operation fails or if the provided year or card number is invalid.
func (s *withdrawStatusHandleGrpc) FindYearlyWithdrawStatusFailedByCardNumber(ctx context.Context, req *pbWithdraw.FindYearWithdrawStatusCardNumber) (*pb.ApiResponseWithdrawYearStatusFailed, error) {
	year := int(req.GetYear())
	cardNumber := req.GetCardNumber()
