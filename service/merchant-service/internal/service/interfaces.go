...
type MerchantCommandService interface {
	...
	RestoreMerchant(ctx context.Context, merchant_id int) (*response.MerchantResponseDeleteAt, *response.ErrorResponse)
...
type MerchantDocumentCommandService interface {
	...
	//   - *response.ErrorResponse: An error if restoration fails.
	RestoreMerchantDocument(ctx context.Context, document_id int) (*response.MerchantDocumentResponseDeleteAt, *response.ErrorResponse)
