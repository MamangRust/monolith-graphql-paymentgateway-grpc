...
import (
	...
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/merchant"
...
func (s *merchantCommandService) RestoreMerchant(ctx context.Context, merchant_id int) (*response.MerchantResponseDeleteAt, *response.ErrorResponse) {
