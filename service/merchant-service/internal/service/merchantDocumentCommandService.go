...
import (
	...
	user_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/user_errors/service"
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/merchantdocument"
...
func (s *merchantDocumentCommandService) RestoreMerchantDocument(ctx context.Context, documentID int) (*response.MerchantDocumentResponseDeleteAt, *response.ErrorResponse) {
