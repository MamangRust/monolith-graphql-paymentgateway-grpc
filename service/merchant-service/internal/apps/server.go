...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/errorhandler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/handler"
	myhandlerkafka "github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/kafka"
	"github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/middleware"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/repository"
	"github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/service"
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-pkg/database"
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbdocument.RegisterMerchantDocumentQueryServiceServer(grpcServer, handler)
	pbStats.RegisterMerchantStatsAmountServiceServer(grpcServer, handler)
	pbStats.RegisterMerchantStatsMethodServiceServer(grpcServer, handler)
	pbStats.RegisterMerchantStatsTotalAmountServiceServer(grpcServer, handler)
}
