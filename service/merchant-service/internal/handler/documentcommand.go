...
import (
	...
	merchantdocument_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/merchant_document_errors/grpc"
	protomapper "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/proto/merchantdocument"
	"go.uber.org/zap"
...
func (s *merchantDocumentCommandHandleGrpc) Restore(ctx context.Context, req *pbdocument.FindMerchantDocumentByIdRequest) (*pbdocument.ApiResponseMerchantDocumentDeleteAt, error) {
	...
	so := s.mapper.ToProtoResponseMerchantDocumentDeleteAt("success", "Successfully restored merchant document", document)
