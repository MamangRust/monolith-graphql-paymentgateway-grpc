...
func (s *merchantStatsAmountHandleGrpc) FindMonthlyAmountMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantMonthlyAmount, error) {
...
//   - An error if the retrieval operation fails.
func (s *merchantStatsAmountHandleGrpc) FindYearlyAmountMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantYearlyAmount, error) {
	year := int(req.GetYear())
...
//   - A pointer to ApiResponseMerchantMonthlyAmount containing the monthly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsAmountHandleGrpc) FindMonthlyAmountByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantMonthlyAmount, error) {
...
//   - A pointer to ApiResponseMerchantYearlyAmount containing the yearly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsAmountHandleGrpc) FindYearlyAmountByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantYearlyAmount, error) {
	merchantId := req.GetMerchantId()
	year := req.GetYear()
...
//     on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsAmountHandleGrpc) FindMonthlyAmountByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantMonthlyAmount, error) {
...
//     on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsAmountHandleGrpc) FindYearlyAmountByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantYearlyAmount, error) {
	api_key := req.GetApiKey()
	year := req.GetYear()
