...
import (
	...
	stats "github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/service/stats"
	statsbyapikey "github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/service/statsbyapikey"
	statsbymerchant "github.com/MamangRust/monolith-graphql-payment-gateway-merchant/internal/service/statsbymerchant"
	...
	merchant_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/merchant_errors/grpc"
	protomapper "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/proto/merchant"
...
func (s *merchantStatsTotalAmountHandleGrpc) FindMonthlyTotalAmountMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantMonthlyTotalAmount, error) {
...
//   - An error if the retrieval operation fails.
func (s *merchantStatsTotalAmountHandleGrpc) FindYearlyTotalAmountMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantYearlyTotalAmount, error) {
	year := int(req.GetYear())
...
//   - A pointer to ApiResponseMerchantMonthlyTotalAmount containing the monthly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsTotalAmountHandleGrpc) FindMonthlyTotalAmountByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantMonthlyTotalAmount, error) {
	year := int(req.GetYear())
...
//   - A pointer to ApiResponseMerchantYearlyTotalAmount containing the yearly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsTotalAmountHandleGrpc) FindYearlyTotalAmountByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantYearlyTotalAmount, error) {
	year := int(req.GetYear())
	id := int(req.GetMerchantId())
...
//   - A pointer to ApiResponseMerchantMonthlyTotalAmount containing the monthly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsTotalAmountHandleGrpc) FindMonthlyTotalAmountByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantMonthlyTotalAmount, error) {
	year := int(req.GetYear())
...
//   - A pointer to ApiResponseMerchantYearlyTotalAmount containing the yearly transaction amounts on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsTotalAmountHandleGrpc) FindYearlyTotalAmountByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantYearlyTotalAmount, error) {
	year := int(req.GetYear())
	apikey := req.GetApiKey()
