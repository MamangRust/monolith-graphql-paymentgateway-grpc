...
func (s *merchantStatsMethodHandleGrpc) FindMonthlyPaymentMethodsMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantMonthlyPaymentMethod, error) {
...
//   - An error if the retrieval operation fails.
func (s *merchantStatsMethodHandleGrpc) FindYearlyPaymentMethodMerchant(ctx context.Context, req *pb.FindYearMerchant) (*pbmerchant.ApiResponseMerchantYearlyPaymentMethod, error) {
	year := int(req.GetYear())
...
//   - A pointer to ApiResponseMerchantMonthlyPaymentMethod containing the monthly payment methods on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsMethodHandleGrpc) FindMonthlyPaymentMethodByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantMonthlyPaymentMethod, error) {
...
//   - A pointer to ApiResponseMerchantYearlyPaymentMethod containing the yearly payment methods on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsMethodHandleGrpc) FindYearlyPaymentMethodByMerchants(ctx context.Context, req *pb.FindYearMerchantById) (*pbmerchant.ApiResponseMerchantYearlyPaymentMethod, error) {
	merchantId := req.GetMerchantId()
	year := req.GetYear()
...
//     on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsMethodHandleGrpc) FindMonthlyPaymentMethodByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantMonthlyPaymentMethod, error) {
...
//     on success.
//   - An error if the retrieval operation fails.
func (s *merchantStatsMethodHandleGrpc) FindYearlyPaymentMethodByApikey(ctx context.Context, req *pb.FindYearMerchantByApikey) (*pbmerchant.ApiResponseMerchantYearlyPaymentMethod, error) {
	api_key := req.GetApiKey()
	year := req.GetYear()
