...
import (
	...
	topup_errors "github.com/MamangRust/monolith-graphql-payment-gateway-shared/errors/topup_errors/service"
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/topup"
...
//   - A response.ErrorResponse pointer containing error information.
func (s *topupCommandService) RestoreTopup(ctx context.Context, topup_id int) (*response.TopupResponseDeleteAt, *response.ErrorResponse) {
