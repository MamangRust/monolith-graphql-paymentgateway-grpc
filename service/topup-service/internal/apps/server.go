...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/errorhandler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/handler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/middleware"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/repository"
	"github.com/MamangRust/monolith-graphql-payment-gateway-topup/internal/service"
...
func (s *Server) Run() {
	...
	metricsAddr := fmt.Sprintf(":%s", viper.GetString("METRIC_TOPUP_ADDR"))
...
func (s *Server) RegisterHandleGrpc(grpcServer *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterTopupStatsAmountServiceServer(grpcServer, handler)
	pbStats.RegisterTopupStatsMethodServiceServer(grpcServer, handler)
	pbStats.RegisterTopupStatsStatusServiceServer(grpcServer, handler)
}
