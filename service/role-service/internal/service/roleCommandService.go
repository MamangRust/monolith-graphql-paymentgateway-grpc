...
import (
	...
	roleservicemapper "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/role"
...
func (s *roleCommandService) RestoreRole(ctx context.Context, id int) (*response.RoleResponseDeleteAt, *response.ErrorResponse) {
