...
import (
	...
	responseservice "github.com/MamangRust/monolith-graphql-payment-gateway-shared/mapper/response/service/card"
...
func (s *cardCommandService) RestoreCard(ctx context.Context, card_id int) (*response.CardResponseDeleteAt, *response.ErrorResponse) {
