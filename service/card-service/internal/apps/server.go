...
import (
	...
	"github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/errorhandler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/handler"
	"github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/middleware"
	mencache "github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/redis"
	"github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/repository"
	"github.com/MamangRust/monolith-graphql-payment-gateway-card/internal/service"
...
func (s *Server) RegisterHandleGrpc(grpc *grpc.Server, handler handler.Handler) {
	...
	pbStats.RegisterCardStatsBalanceServiceServer(grpc, handler)
	pbStats.RegisterCardStatsTopupServiceServer(grpc, handler)
	pbStats.RegisterCardStatsTransactionServiceServer(grpc, handler)
	pbStats.RegisterCardStatsTransferServiceServer(grpc, handler)
	pbStats.RegisterCardStatsWithdrawServiceServer(grpc, handler)
}
